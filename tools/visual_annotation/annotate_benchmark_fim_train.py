...
Input:  data/benchmarks/sft_data/rendered_chatml_fim_train.jsonl
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input_path", default="data/benchmarks/sft_data/rendered_chatml_fim_train.jsonl")
    parser.add_argument("--output_path", default="data/benchmarks/sft_data/ours_graphsignal_train.json")
    ...
    parser.add_argument(
        "--static_viz_dir",
        default="outputs/visual_annotation/visualization/ours_graphsignal_static",
