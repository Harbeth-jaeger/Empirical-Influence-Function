...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--raw_data_path", default="data/benchmarks/sft_data/rendered_chatml_fim_train.jsonl")
    parser.add_argument("--edge_data_path", default="data/benchmarks/sft_data/ours_graphsignal_train.json")
    ...
    parser.add_argument("--template_path", default="tools/visual_annotation/dynamic_annotation_viewer.html")
    parser.add_argument("--output_html", default="outputs/visual_annotation/visualization/annotation_showcase_dynamic_annotation_viewer.html")
    parser.add_argument("--output_json", default="outputs/visual_annotation/visualization/annotation_showcase_samples.json")
    parser.add_argument("--output_csv", default="outputs/visual_annotation/visualization/annotation_showcase_candidates.csv")
