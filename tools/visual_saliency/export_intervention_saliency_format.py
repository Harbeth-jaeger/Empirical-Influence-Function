...
DEFAULT_OUTPUT = ROOT / "outputs/visual_saliency/saliency_intervention_format.json"
...
def main() -> None:
    ...
    out = {
        ...
        "note": "Current visual_saliency data stores top-k sources only; saliency vectors are zero-filled except stored top-k source positions.",
