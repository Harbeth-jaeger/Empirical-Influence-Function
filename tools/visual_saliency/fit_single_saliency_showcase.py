...
DEFAULT_RICH = ROOT / "outputs/visual_annotation/rich_top_edges/viewer_data.json"
DEFAULT_TRAIN = ROOT / "data/benchmarks/sft_data/ours_graphsignal_train.json"
DEFAULT_DATA = ROOT / "outputs/visual_saliency/base_vs_ours_annotation_saliency_data_v2.json"
DEFAULT_MODEL_OUT = ROOT / "outputs/visual_saliency/rich_line319_saliency_only_lora"
DEFAULT_REPORT = ROOT / "outputs/visual_saliency/rich_line319_saliency_only_report.json"
...
def annotation_payload(rich_sample: dict[str, Any], token_by_idx: dict[int, dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "note": "Ground-truth completion; annotation-rich showcase from outputs/visual_annotation/rich_top_edges.",
    }
