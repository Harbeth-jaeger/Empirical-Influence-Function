...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--rich_data", default="outputs/viz_annotation/rich_top_edges/viewer_data.json")
    parser.add_argument("--saliency_data", default="outputs/viz_saliency/rich_top_edges_saliency_data.json")
    parser.add_argument("--output_path", default="outputs/viz_saliency/base_vs_ours_annotation_saliency_data_v2.json")
...
def annotation_payload(rich_sample: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "note": "Annotation edges come from outputs/viz_annotation/rich_top_edges.",
    }
