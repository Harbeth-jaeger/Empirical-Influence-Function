...
DEFAULT_OUTPUT = Path("outputs/go_single/eval_results/codesearchnet_go_internal_results.jsonl")
DEFAULT_SUMMARY = Path("outputs/go_single/eval_results/codesearchnet_go_internal_summary.json")
DEFAULT_TABLE = Path("outputs/go_single/eval_results/codesearchnet_go_internal_table.md")
