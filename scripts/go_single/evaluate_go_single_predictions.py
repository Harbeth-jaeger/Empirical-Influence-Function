...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--output", type=Path, default=Path("outputs/go_single/eval_results/go_single_eval_results.jsonl"))
    p.add_argument("--summary", type=Path, default=Path("outputs/go_single/eval_results/go_single_eval_summary.json"))
