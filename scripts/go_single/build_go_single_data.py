...
from scripts.go_single.go_single_pipeline import (  # noqa: E402
    BuildStats,
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--report", type=Path, default=Path("outputs/go_single/reports/go_single_v2_build_report.md"))
    p.add_argument("--samples-report", type=Path, default=Path("outputs/go_single/reports/go_single_v2_samples.md"))
