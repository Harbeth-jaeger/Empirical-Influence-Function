...
def main() -> None:
    ...
    ap.add_argument("--eval_path", default="/mnt/nvme0n1/wenhao/datasets/Empirical-Influence-Function/interim/benchmark_legacy_fim/eval_data/rendered_chatml_fim_eval.jsonl")
