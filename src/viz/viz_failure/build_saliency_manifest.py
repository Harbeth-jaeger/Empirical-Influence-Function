...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--failure_data", default="outputs/viz_failure/ours_vs_clear_humaneval1000.json")
    parser.add_argument("--output_path", default="outputs/viz_failure/ours_vs_clear_humaneval1000_saliency_manifest.json")
...
def main() -> None:
    ...
    payload = {
        ...
        "usage": "Pass this file to src/tools/viz_saliency/compute_model_saliency.py --sample_manifest.",
        "samples": out_samples,
    }
