...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--data_path", default="outputs/viz_failure/ours_vs_clear_humaneval1000.json")
    p.add_argument("--output_path", default="outputs/viz_failure/ours_vs_clear_failure_viewer.html")
    return p.parse_args()
