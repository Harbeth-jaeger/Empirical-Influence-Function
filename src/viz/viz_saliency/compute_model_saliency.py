...
DEFAULT_MANIFEST = ROOT / "outputs/viz_saliency/saliency_viz_samples.json"
DEFAULT_OUTPUT = ROOT / "outputs/viz_saliency/saliency_comparison_data.json"
DEFAULT_CACHE_DIR = ROOT / "outputs/viz_saliency/alti_freerun_cache"
