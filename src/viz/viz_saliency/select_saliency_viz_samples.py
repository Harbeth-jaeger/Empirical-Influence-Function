...
DEFAULT_TRAIN_PATH = ROOT / "/mnt/nvme0n1/wenhao/datasets/Empirical-Influence-Function/interim/benchmark_legacy_fim/sft_data/rendered_chatml_fim_train.jsonl"
DEFAULT_OUTPUT_PATH = ROOT / "outputs/viz_saliency/saliency_viz_samples.json"
...
def rebuild_row_with_clean_code(row: dict[str, Any], language: str) -> dict[str, Any] | None:
    ...
    clean["viz_saliency_comments_stripped"] = True
