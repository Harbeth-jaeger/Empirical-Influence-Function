...
DEFAULT_TRAIN_PATH = "/mnt/nvme0n1/wenhao/datasets/Empirical-Influence-Function/interim/benchmark_legacy_fim/sft_data/rendered_chatml_fim_train.jsonl"
DEFAULT_EDGE_DATA_PATH = "/mnt/nvme0n1/wenhao/datasets/Empirical-Influence-Function/interim/benchmark_legacy_fim/sft_data/ours_graphsignal_train.json"
...
def main() -> None:
    ...
    print(
        "Put this file under the repository root if you want src/tools/correlation-report "
